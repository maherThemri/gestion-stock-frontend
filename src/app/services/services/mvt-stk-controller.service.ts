...
export class MvtStkControllerService extends BaseService {
  ...
  static readonly CorrectionStockPosPath = '/mvtStks/correctionpos';
  ...
  static readonly CorrectionStockNegPath = '/mvtStks/correctionneg';
  ...
  static readonly MvtStkArticlePath = '/mvtStks/filter/article/{idArticle}';
